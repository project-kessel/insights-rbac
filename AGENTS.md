...
| [`docs/integration-guidelines.md`](docs/integration-guidelines.md) | Kessel Relations/Inventory (gRPC), Kafka producer/consumer, Debezium CDC, BOP, IT Service, notifications, feature flags, Prometheus metrics |
